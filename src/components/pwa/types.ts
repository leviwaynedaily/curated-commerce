...
export const pwaFormSchema = z.object({
  ...
  icon_72x72: z.string().nullable().optional(),
  icon_96x96: z.string().nullable().optional(),
  icon_128x128: z.string().nullable().optional(),
  icon_144x144: z.string().nullable().optional(),
  icon_152x152: z.string().nullable().optional(),
  icon_192x192: z.string().min(1, "A 192x192 icon is required for PWA"),
  icon_384x384: z.string().nullable().optional(),
  icon_512x512: z.string().min(1, "A 512x512 icon is required for PWA"),
  screenshot_mobile: z.string().nullable().optional(),
  screenshot_desktop: z.string().nullable().optional(),
});
