    ...
    queryFn: async () => {
      try {
        ...
        if (lastStorefrontId) {
          ...
          console.log("Attempting to fetch last accessed storefront:", lastStorefrontId)
          ...
          if (specificError) {
            ...
            toast.error("Failed to load last accessed storefront")
          }
          ...
          if (specificStorefront) {
            ...
            console.log("Last accessed storefront not found, fetching first available")
          }
        }
        ...
        if (data) {
          ...
          console.log("No storefronts found for business")
        }
